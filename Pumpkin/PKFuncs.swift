...
private let view_height = (cgfloat: UIScreen.main.bounds.size.height,double: Double(UIScreen.main.bounds.size.height));
private let view_width = (cgfloat: UIScreen.main.bounds.size.width,double: Double(UIScreen.main.bounds.size.width));
